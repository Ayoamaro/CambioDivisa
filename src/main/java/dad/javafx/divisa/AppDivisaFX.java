 ...
 *
 */
public class AppDivisaFX extends Application {
	...
	private void onCambiarAction(ActionEvent e) {
		...
		Divisa divisaDestino = origenCombo.getSelectionModel().getSelectedItem();

		Double enEuros = divisaOrigen.fromEuro(cantidadOrigen);
